...
subprocess.run(["./chmod-x-install_nmslib.sh/install_nmslib.sh"], check=True)
...
if option:
    ...
    cleaned_title = re.sub(r'\s*\(.*?\)', '', option)
    val_index = books[books['original_title']==cleaned_title].index
